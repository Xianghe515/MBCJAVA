...
public class ObjectEx {
	...
	public static void main(String[] args) {
		...
		System.out.println("p2.hashCode(): " + p2.hashCode());	// name과 age가 같다면 새롭게 만들지 않고 이전에 사용한 것의 주소를 불러와서 사용함
		System.out.println("p3.hashCode(): " + p3.hashCode());
		System.out.println("p1.equals(p2): "+ p1.equals(p2));	// 결과 : true
//		같은 값을 전달하면 같은 객체로, 다른 값을 전달하면 다른 객체로 구분
	}
...
record Person(String name, int age) {} // Stirng name, int age는 클래스의 필드 값이 됨