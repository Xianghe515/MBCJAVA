...
public class FileEx2 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// 파일 정보 얻기
			System.out.println("파일 유형 : " + Files.probeContentType(path)); // 결과 : 파일 유형 : text/plain
			System.out.println("파일 크기 : " + Files.size(path) + " bytes"); 	// 결과 : 파일 크기 : 56 bytes
